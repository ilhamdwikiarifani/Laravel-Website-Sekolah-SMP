	...
	<div class="hero overlay">
	    ...
	    <div class="container mb--berita  d-flex justify-content-center align-items-center">
	        <p class="d-none d-md-flex pt-4 "> <a href="#">Informasi</a> &nbsp; - <span> &nbsp; Document / File</span></p>
	    </div>
	</div>
	                ...
	                <div class="col-12 mb-4" data-aos="fade-up" data-aos-delay="300">
	                    <div class="border rounded-3 d-block d-md-flex  justify-content-between align-items-center w-100 p-4 animate">
	                        <div class="d-flex justify-content-start align-items-center gap-2 mb-4 mb-md-0">
	                            <div class=""><img src="https://img.icons8.com/fluency/48/null/document.png"
	                                    width="50" />
	                            </div>
	                            <div class="">
	                                <h6 class="text-tebal -mb-judul">{{ $dcmn->nama }}</h6>
	                                <p class="text-dcm"><i class="lni lni-calendar"></i> &nbsp;
										@php
										$date = new DateTime($dcmn->published_at);
										@endphp
										{{ $date->format('D, d M Y | H:i:s') }}&nbsp; <span class="text-info-date"><i class="lni lni-timer"></i> {{ $dcmn->created_at->diffForHumans() }}</span></p>
	                            </div>
	                        </div>
	                        <div class="">
	                            <a href="{{ asset('storage/'.$dcmn->file) }}" class=" px-3 py-2 bg-dark text-white rounded-1 " download><i class="lni lni-download"></i> &nbsp; Download</a>
	                        </div>
	                    </div>
