    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Link / Tautan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('tautans.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="row">
                     ...
                     <div class="col-12">
                        <div class="input-style-2">
                            <label>Link</label>
                            <input type="text" placeholder="Masukan Link https://"  name="link" id="link" value="{{ old('link') }}"
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                        <div class="input-style-2">
                            ...
                            <input type="text" placeholder="Masukan nama link"  name="nama"  value="{{ old('nama') }}"
                                class="form-control mt-1- rounded-2 " required/>
                            {{-- <span class="icon"> <i class="lni lni-slice"></i> </span> --}}
                            <div class="invalid-feedback">
                                    The Nama Link field is required.
                            </div> 
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="title mb-30">
                        <h2 class="mt-3">Link / Tautan</h2>
                        <div class="d-flex gap-2">
                            <a href="{{ url('/admin-page/tautan/create') }}" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
            ...
            <div class="col-12 p-4 overflow-auto">
                <table id="example" class="table table-bordered table-light nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ Str::limit($ttn->nama, 20) }}</td>
                            <td><a href="{{ $ttn->link }}" target="_blank">{{ Str::limit($ttn->link, 30) }}</a></td>
                             @php
                                $date = new DateTime($ttn->waktu);
                            @endphp

                            <td>{{ $date->format('D, d M Y | H:i:s') }}</td>
                           <td >

                                <form action="{{ route('tautans.destroy',$ttn->id) }}" method="POST">

                                    <a href="{{ url('/admin-page/tautan/show',$ttn->id) }}"
                                    ...
                                    <ul class="dropdown-menu delete-menu dropdown-menu-end p-2"
                                        ...
                                        <li>
                                            <a href="{{ url('/admin-page/tautan/edit',$ttn->id) }}" 
